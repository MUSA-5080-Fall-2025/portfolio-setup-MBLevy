...
dataPA <- get_acs(geography = "county", variables = c(popTotal = "B01003_001",
                                                       medIncome = "B19013_001"),
                    year = 2022, state = "PA", survey = "acs5", output = "wide")
dataPA
# Clean the county names to remove state name and "County" 
# Hint: use mutate() with str_remove()
dataPA <- dataPA %>% mutate(countyName = str_remove(NAME, " County, Pennsylvania")) 
...
dataPA <- dataPA %>% mutate(moePercentage = (medIncomeM/medIncomeE)*100)
dataPA <- dataPA %>% mutate(reliability = case_when(
...
kable(sumDemos,
      col.names = c("County", "Average CT % White Residents", "Average CT % Black Residents",
