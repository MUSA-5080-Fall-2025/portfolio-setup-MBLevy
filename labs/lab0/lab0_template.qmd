...
**Your answer:** 
The tibble version prints the first 10 rows in a much more readible format, whereas the data frame prints 142 rows (which could be messy depending on size of console frame)
