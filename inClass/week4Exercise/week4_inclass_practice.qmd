...
pa_counties <- st_read(here("inClass/week4Exercise/data/Pennsylvania_County_Boundaries.shp"))
districts <- st_read(here("inClass/week4Exercise/data/districts.geojson"))
hospitals <- st_read(here("inClass/week4Exercise/data/hospitals.geojson"))
