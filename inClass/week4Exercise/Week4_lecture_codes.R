...
# Read a shapefile
pa_counties <- st_read("inClass/week4Exercise/data/Pennsylvania_County_Boundaries.shp")

# Read GeoJSON
districts <- st_read("inClass/week4Exercise/data/districts.geojson")
hospitals <- st_read("inClass/week4Exercise/data/hospitals.geojson")
