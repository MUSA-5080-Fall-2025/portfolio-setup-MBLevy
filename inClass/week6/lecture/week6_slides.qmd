...
nhoods <- read_sf(here("inClass/week6/data/BPDA_Neighborhood_Boundaries.geojson")) %>%
...
# load data
bostonCrimes <- read_csv(here("inClass/week6/data/bostonCrimes.csv"))
...
nhoods <- st_read(here("inClass/week6/data/BPDA_Neighborhood_Boundaries.geojson")) %>%
  st_transform('ESRI:102286')
